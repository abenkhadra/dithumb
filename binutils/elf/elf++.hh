...
public:
        ...
        /**
         * Return the section at the given index.  qIf no such section
...
public:
       ...
       /**
        * Return this segment's data.
        */
       const void *data() const;

        /**
         * Return the size file of this segment in bytes.
         */
        size_t phsize() const;

        /**
         * Return the size in memory of this segment in bytes.
         */
...
public:
         ...
         * section_type_mismatch if this section is snot a symbol
         * table.
         */
